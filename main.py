...
async def summarize_book(ctx, *, book_title: str):
    prompt = f"""
    You are a helpful AI literature guide.
    Provide:
    1. A 2–3 sentence summary of "{book_title}".
    2. 2–3 main themes or ideas.
    3. A brief note on why this book is important or memorable.
    """
