...
async def summarize_book(ctx, *, book_title: str):
    ...
    1. A clear, 2–3 sentence summary of the plot in your own words.  
    2. 2–3 main themes or ideas, explained in simple language.  
    3. A brief note on why this book matters.  
    Make it witty, fun, and conversational, while keeping the language polite and respectful.  
   """
